...
class FinalRegistrationPageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    @IBAction func OnClickPaymentAccountType(_ sender: Any) {
        ...
        var h: CGFloat
        if dataSource.count < 4 { h = CGFloat(dataSource.count * 50) } else { h = 200}
        ...
        Utilities.addTransparentView( textField: selectedTextField, tableView: tableView, transparentView: transparentView, view: MainView, point: p, height: h)
